...
.tuning-progress-overlay{position:fixed;inset:0 0 0 var(--sidebar-width);z-index:2000;justify-content:flex-start;min-height:0;padding:clamp(110px,16vh,170px) 32px 32px;border-radius:0;backdrop-filter:blur(3px)}
@media(max-width:760px){.tuning-progress-overlay{inset:4rem 0 0;padding:72px 20px 24px}}
</style>
