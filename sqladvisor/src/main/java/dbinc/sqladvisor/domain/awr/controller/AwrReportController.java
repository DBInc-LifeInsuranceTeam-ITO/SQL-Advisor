...
public class AwrReportController {
    ...
    public ResponseEntity<ApiResponse<AwrDtos.UploadResponse>> uploadReport(@RequestPart("file") MultipartFile file) throws IOException {
        return ResponseEntity
                .status(HttpStatus.CREATED)
                .body(ApiResponse.created(awrReportService.upload(file)));
    }
